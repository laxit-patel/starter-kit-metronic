    ...
    <div id="kt_content_container" class="container-fluid">
        ...
        <form action="#" id="filter_panel">
            ...
            <div class=" row d-flex align-items-center">
                ...
                <div class="col-md-3">
                 <div class="mb-0">
                     <div class="btn-group w-100">
                         <button type="button" class="btn btn-light-danger btn-hover-scale" onclick="resetFilter()">
                             <i class="fa fa-redo"></i>
                         </button>
                         <!--begin::Trigger-->
                         <button type="button" class="btn btn-light-primary btn-hover-scale"
                ...
                <div class="col-md-1">
                    <div class="mb-0">
                        <a href="{{ route('admin.question.create') }}" type="button" class="btn w-100 btn-light-success btn-hover-scale"  onclick="resetFilter()">
                    ...
                    <div id="qbody_{{$index}}" class="accordion-collapse collapse {{ $index == 0 ? 'show' : '' }}" aria-labelledby="qhead_{{$index}}" data-bs-parent="#question_accordian">
                        ...
                        <div class="row bg-light-dark m-0 p-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <a 
                                class="badge cursor-pointer float-end badge-success badge-lg" 
...
<!--end::Post-->
@include('admin.question.modal.assign')
@endsection
