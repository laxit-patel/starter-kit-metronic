...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card-body pt-9 pb-0">
                ...
                <ul class="nav nav-fill nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" data-bs-toggle="tab" href="#tab_overview">
                    ...
                    <!--end::Nav item-->
                     <!--begin::Nav item-->
                     <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 " data-bs-toggle="tab" href="#tab_profile">
                            <i class="fa fa-id-card-alt me-2"></i>
                            Profile
                        </a>
                    </li>
                    <!--end::Nav item--> 
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="shadow-lg tab-pane fade show active card mb-5 mb-xl-10" id="tab_overview" role="tabpanel">
                <!--begin::Card header-->
                <div class="card-header cursor-pointer">
                    <!--begin::Card title-->
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Course & Batch</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                            ...
                            <tbody class="fs-6 fw-bold text-gray-600">
                                <tr>
                                    <td>Batch</td>
                                    <td><span class="badge badge-lg badge-primary">{{ $student->profile->getBatch->name }}</span></td>
                                    <td class="text-end">
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark fw-bolder">
                                        {{ $student->profile->getBatch->getCourse->name }}
                                        <p class="text-muted fw-lighter">
                                            {{ $student->profile->getBatch->getCourse->description }}
                                        </p>
                                    </td>
                                    <td class="text-end">
            ...
            <div class="shadow-lg tab-pane fade show card mb-5 mb-xl-10" id="tab_profile" role="tabpanel">
                <!--begin::Card header-->
