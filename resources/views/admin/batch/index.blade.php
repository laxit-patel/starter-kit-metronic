@extends('admin.layouts.main',['title' => 'Batch'])
...
<li class="breadcrumb-item px-3 text-primary">Batch</li>
@endsection
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" id="search" data-kt-docs-table-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search Batch" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
