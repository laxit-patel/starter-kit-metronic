            ...
            <div class="card-title">
                ...
                <div class="d-flex justify-content-center flex-column me-3">
                    ...
                    <div class="mb-0 lh-1">
                        ...
                        <span class="fs-7 fw-bold text-muted">New Notifications</span>
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::User-->
            ...
            <div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
                ...
                <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7 ribbon ribbon-top ribbon-vertical">
                    <div class="ribbon ribbon-triangle ribbon-top-end border-success rounded">
                        <!--begin::Ribbon icon-->
                        <a href="" class="ribbon-icon mt-n6 me-n6">
                    ...
                    <div class="flex-grow-1 me-2">
                        <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">you won the prize</a>
                        <span class="text-muted fw-bold d-block">some details</span>
                        <hr class="flex-row">
                    <div>
                        11:50 am
                        <a class="badge badge-success float-end">open</a>
                    </div>
                    </div>
                    <!--end::Title-->
